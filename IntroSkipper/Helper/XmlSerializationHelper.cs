            ...
            if (File.Exists(filePath))
            {
                try
                {
                    ...
                    if (xmlDoc.DocumentElement.HasAttribute("xmlns:xsi"))
                    {
                        ...
                        xmlDoc.DocumentElement.SetAttribute("xmlns", "http://schemas.datacontract.org/2004/07/IntroSkipper");
                    ...
                    if (xmlDoc.DocumentElement.NamespaceURI == "http://schemas.datacontract.org/2004/07/IntroSkipper.Data")
                    {
                        xmlDoc.DocumentElement.SetAttribute("xmlns", "http://schemas.datacontract.org/2004/07/IntroSkipper");
                        // Save the modified XML document
                        xmlDoc.Save(filePath);
                    ...
                    if (xmlDoc.DocumentElement.NamespaceURI == "http://schemas.datacontract.org/2004/07/IntroSkipper")
                    {
