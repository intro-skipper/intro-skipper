...
/// <param name="Scenes">Every black scene the black-frame rules accepted, relative to the credits fingerprint start, the picked one with its refined start; empty when <paramref name="Credits" /> is <see langword="null" />. The card analyzer treats black and card-like keyframes inside any of them as black cards.</param>
