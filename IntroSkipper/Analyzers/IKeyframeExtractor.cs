...
/// Implementations normalize timestamps from various source formats (MKV, ffprobe) to seconds.
/// </summary>
public interface IKeyframeExtractor
{
    /// <summary>
    /// Extracts keyframe data from a video file.
    /// All timestamps in the returned KeyframeData are normalized to seconds regardless of source format.
    /// </summary>
    /// <param name="filePath">Path to the video file.</param>
    /// <returns>KeyframeData containing duration and keyframe timestamps, both in seconds.</returns>
