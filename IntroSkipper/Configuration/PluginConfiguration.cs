...
public class PluginConfiguration : BasePluginConfiguration
{
    ...
    /// <summary>
    /// Gets or sets the CSV list of series names to exclude from analysis.
    /// </summary>
    public string ExcludeSeries { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the CSV list of movie titles to exclude from analysis.
    /// </summary>
    public string ExcludeMovies { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the CSV list of file path fragments to exclude from analysis.
    ...
    /// </summary>
    public string ExcludePaths { get; set; } = string.Empty;
