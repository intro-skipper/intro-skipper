...
public sealed class DbDisabledItem
{
    ...
    /// every disable write, so a key gone stale after an item moves seasons heals itself. Exists
    /// only to serve the season-scoped listing; cleanup prunes by item ID.
    /// </summary>
