...
fingerprint or detection data by the plugin authors. Any such data you
generate or share is your responsibility. Extracting, using, or
distributing such data separately from your own personal use may violate
the licenses, terms of service, or other agreements governing the
underlying media or software — it is your responsibility to research and
comply with all applicable terms before doing so. Claiming ownership of
or submitting such data to other sites and services should be done at
your own discretion, with proper research into your rights to do so. The
authors make no representations about your right to use, distribute, or
commercialize this data, and expressly disclaim any liability arising
from such use.
