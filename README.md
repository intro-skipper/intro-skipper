...
and Intro Skipper installed, SkipMe's synced timestamps become authoritative analyzer
inputs instead of a separate Jellyfin segment provider. Manual edits stay protected;
